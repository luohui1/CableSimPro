...
export default function EngineeringCanvas(){
 ...
 </div><div className="canvas-hint"><LockKeyhole size={12}/><span>均匀土壤 · ρth = {fmt(e.soil_rho_k_m_w,2)} K·m/W · 1 回路 / 3 × 单芯 · {e.arrangement==='flat'?'水平排列':'等边三角排列'}<br/>拖动外相调整间距与埋深；中相 / 顶相调整埋深。仅支持规则排列，不是任意多回路 CAD。</span></div></div>;
}
