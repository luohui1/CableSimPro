...
export default defineConfig({
 ...
 projects:[
  {name:'chromium',testMatch:['desktop.spec.ts','domains.spec.ts'],use:{...devices['Desktop Chrome'],viewport:{width:1600,height:1000},launchOptions:{args:['--use-gl=angle','--use-angle=swiftshader','--enable-unsafe-swiftshader']}}},
  {name:'webkit',testMatch:['desktop.spec.ts','domains.spec.ts'],use:{...devices['Desktop Safari'],viewport:{width:1600,height:1000}}},
