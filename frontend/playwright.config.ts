...
export default defineConfig({
 testDir:'./pro-e2e',timeout:60000,expect:{timeout:15000},fullyParallel:false,workers:1,retries:0,maxFailures:6,
 ...
 projects:[
  {name:'chromium',testMatch:['desktop.spec.ts','design.spec.ts'],use:{...devices['Desktop Chrome'],viewport:{width:1600,height:1000},launchOptions:{args:['--use-gl=angle','--use-angle=swiftshader','--enable-unsafe-swiftshader']}}},
  {name:'webkit',testMatch:['desktop.spec.ts','design.spec.ts'],use:{...devices['Desktop Safari'],viewport:{width:1600,height:1000}}},
