...
export default defineConfig({
 ...
 projects:[
  {name:'chromium',testMatch:['desktop.spec.ts','domains.spec.ts','field-scale.spec.ts','vertical.spec.ts','v05.spec.ts','same-workspace.spec.ts','enterprise.spec.ts','dual-mode.spec.ts','agent-studio.spec.ts'],use:{...devices['Desktop Chrome'],viewport:{width:1600,height:1000},launchOptions:{executablePath:process.env.CABLESIM_TEST_CHROMIUM,args:['--use-gl=angle','--use-angle=swiftshader','--enable-unsafe-swiftshader']}}},
  {name:'webkit',testMatch:['desktop.spec.ts','domains.spec.ts','field-scale.spec.ts','vertical.spec.ts','v05.spec.ts','same-workspace.spec.ts','enterprise.spec.ts','dual-mode.spec.ts','agent-studio.spec.ts'],use:{...devices['Desktop Safari'],viewport:{width:1600,height:1000}}},
