...
const referenceLayout=JSON.parse(readFileSync(fileURLToPath(new URL('../../docs/design/reference-layout.json',import.meta.url)),'utf8')) as {landmarks_at_source_size:{rail:[number,number,number,number]}};
