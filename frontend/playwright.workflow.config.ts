...
export default defineConfig({...common,
 ...
 projects:[{...common.projects![0],name:'workflow-chromium',testMatch:['engineering-workflow.spec.ts','workflow-home.spec.ts','dual-mode.spec.ts','same-workspace.spec.ts']}],
});
