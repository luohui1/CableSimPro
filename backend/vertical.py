...
Ported from the sibling design-ocr-v04 implementation; integrated with the shared catalog.
"""
...
def vertical_study(cable:Cable,config:Vertical,current:float):
    ...
    return {'model':'VERTICAL-FV-0.4.1','ampacity_a':rating,'rating':rated,'operating':operating,'operating_error':error,
