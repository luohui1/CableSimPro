...
def collect():
    ...
    for name in ['scipy','pypdf','Pillow','python-multipart','fastapi','pydantic','numpy','uvicorn','httpx','langgraph','langchain-core','langgraph-checkpoint','langgraph-prebuilt','langgraph-sdk','langsmith']:
        try:
