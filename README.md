# CableSimPro 0.7.2 · 工程视觉资产与浅色双模式

本轮开发分支 `feat/engineering-visual-assets-v072`。入口、任务页和专业工作台集成原创建模配图与改进的实时三维显示。具体范围、资产生成方式及验证方法见 `docs/VISUAL_V072.md`。没有扩大原有求解器或标准支持范围。
