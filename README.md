# CableSimPro — v0.7.3 整合开发版

本轮将任务式双模式与原创工程配图整合到 `feat/unified-engineering-studio-v073`。
入口说明图本地加载，实际参数、审批与数值结果仍使用同一个工程会话。
详见 [整合范围、配图来源与验收](docs/UNIFIED_STUDIO_V073.md)。
